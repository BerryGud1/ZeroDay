...
if isfolder("ZeroDay/sound") == false then
    makefolder("ZeroDay/sound")
end

if isfolder("ZeroDay/sound/mc") == false then
    makefolder("ZeroDay/sound/mc")
end

if isfolder("ZeroDay/assets") == false then
    makefolder("ZeroDay/assets")
end

if isfolder("ZeroDay/config") == false then
    makefolder("ZeroDay/config")
end

if isfolder("ZeroDay/scripts") == false then
    makefolder("ZeroDay/scripts")
end

local sliderapi = {}

local foldername = "ZeroDay/config"
local conf = {
...
local function getcustomassetfuncforsounds(path)
    if not betterisfile(path) then
        ...
        local req = requestfunc({
            Url = "https://raw.githubusercontent.com/8pmX8/rektsky4roblox/main/"..path:gsub("ZeroDay/sound", "sound"),
            Method = "GET"
        })
        writefile(path, req.Body)
    end
...
local function playdingsound(istrue) 
    if lib["Sounds"] then
        if istrue then
            playsound(getcustomassetfuncforsounds("ZeroDay/sound/enable.mp3") or getasset("ZeroDay/sound/enable.mp3"))
        else
            playsound(getcustomassetfuncforsounds("ZeroDay/sound/disable.mp3") or getasset("ZeroDay/sound/disable.mp3"))
        end
    end
end
...
function lib:CreateWindow()
    ...
    function lib:CreateTab(title, color, asset)
        ...
        assetthing.Image = getcustomassetfunc("ZeroDay/assets/" .. asset .. ".png") or getasset("ZeroDay/assets/" .. asset .. ".png")
        local tabtable = {
            ["Toggles"]={}
        }
